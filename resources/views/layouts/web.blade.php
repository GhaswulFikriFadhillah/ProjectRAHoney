...
<head>
  ...
  <link rel="stylesheet" href="kaira/https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css" />
...
<body class="homepage">
    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-md-8 text-center" data-aos="fade-up" data-aos-delay="300">
          <p>RA Honey – Madu Murni Nektar Hutan Akasia Riau adalah madu alami berkualitas tinggi yang dihasilkan oleh
            lebah Apis mellifera dari nektar bunga akasia di hutan tropis Riau. Dengan tekstur kental, rasa manis
            lembut, dan aroma floral khas, madu ini dipanen secara alami tanpa bahan tambahan, memastikan kemurnian dan
            keasliannya. Kaya akan nutrisi, RA Honey mendukung kesehatan tubuh, meningkatkan imunitas, dan menjadi
            sumber energi alami. Diproses dengan metode ramah lingkungan, RA Honey tidak hanya menjaga kualitas
            produknya, tetapi juga berkontribusi pada keberlanjutan ekosistem hutan akasia. Pilihan sempurna untuk gaya
            hidup sehat Anda!</p>
        </div>
      </div>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="kaira/images/banner-image-6.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
      ...
      <div class="row">
        <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="0">
          <div class="py-5">
            ...
            <p>RA Honey adalah madu murni berkualitas tinggi dari nektar akasia Riau, tanpa campuran bahan kimia.</p>
          </div>
        </div>
        ...
        <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="600">
          <div class="py-5">
            ...
            <p>Madu dipanen langsung dari lebah Apis mellifera tanpa melalui pemanasan berlebih, menjaga nutrisi alami.
            </p>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          <div class="col-md-6 column-container">
            <div class="image-holder">
              <img src="kaira/images/single-image-2.jpg" alt="collection" class="product-image img-fluid">
            </div>
          </div>
          <div class="col-md-6 column-container bg-white">
            <div class="collection-content p-4 m-0 m-md-4">
              ...
              <p>Rasakan kelezatan dan manfaat alami RA Honey, madu murni dari nektar bunga akasia di hutan Riau.
                Diproduksi secara alami tanpa bahan tambahan, RA Honey hadir untuk mendukung kesehatan Anda dengan rasa
                manis yang lembut, aroma floral khas, dan nutrisi alami yang terjaga. Jadikan RA Honey pilihan tepat
                untuk gaya hidup sehat Anda hari ini!</p>
              <a href="https://wa.me/62895705049191"
                class="btn btn-dark text-uppercase mt-3">Pesan Sekarang via WhatsApp</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row g-0">
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <img src="kaira/images/insta-item1.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <img src="kaira/images/insta-item2.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <img src="kaira/images/insta-item3.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <img src="kaira/images/insta-item4.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <img src="kaira/images/insta-item5.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <img src="kaira/images/insta-item6.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-6 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <img src="kaira/images/main-logo.png" alt="logo">
              </a>
            </div>
  ...
  <script src="kaira/https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
    integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"
    crossorigin="anonymous"></script>
  <script src="kaira/https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
